...
```
OAuthSample/
戍式式 OAuthMAUI/                    # .NET MAUI cross-platform app
弛   戍式式 Platforms/               # Platform-specific code
弛   戍式式 Services/CloudProviders/ # OAuth provider implementations
弛   戍式式 Pages/                   # XAML pages
弛   戌式式 Resources/               # Images, fonts, styles
戍式式 OAuthWinUI/                  # WinUI 3 Windows app
弛   戍式式 Services/                # Windows-specific services
弛   戍式式 ViewModels/              # MVVM view models
弛   戌式式 Views/                   # WinUI pages and controls
戍式式 OAuthWebAPI/                 # ASP.NET Core Web API
弛   戌式式 Controllers/             # API controllers
戌式式 OAuthShared/                 # Shared library
    戍式式 ICloudProvider.cs        # Provider interface
    戌式式 UserDetails.cs           # Shared models
```
